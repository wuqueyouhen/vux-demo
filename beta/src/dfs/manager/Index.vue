<template>
  <div>
    ...
    <div style="width: 80%;margin:0 auto">
      <button-tab>
        <button-tab-item>当日</button-tab-item>
        <button-tab-item selected>当周</button-tab-item>
        <button-tab-item>当月</button-tab-item>
      </button-tab>
    </div>
    <div>
      <br/>
      <card>
        ...
        <div slot="content">
          <div>
            <lp-progress :percent="80"></lp-progress>
          </div>
...
<script>
  import {
    XHeader, Group, Flexbox, FlexboxItem, XCircle,
    ButtonTab, ButtonTabItem,
    XTable, LoadMore, Divider, Card, XButton, XProgress
  } from 'vux'
